...
<%@page import="java.util.List, com.lab.dao.EventDAO, com.lab.model.Event"%>
<%
    ...
    // Declare the DAO here at the top so ALL widgets can use it safely
    EventDAO dao = new EventDAO();
%>
<!DOCTYPE html>
<html>
<head>
    <title>COMTECH - Dashboard</title>
...
<body>
    ...
    <div class="grid-container">
        <%-- Role-Based Cards with CORRECTED links --%>
        ...
        <% } else if ("MEMBER".equals(role)) { %>
            ...
            <div class="card"><h3>Submit Feedback</h3><p>Leave comments.</p><a href="feedbackForm.jsp" class="btn btn-blue">Give Feedback</a></div>
        <% } %>
    </div>
