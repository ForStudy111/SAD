...
<%@page import="java.util.List, com.lab.model.Event"%>
...
<html>
    <head>
        <title>COMTECH - My Reservations</title>
        <link rel="stylesheet" type="text/css" href="style.css">
        <style>
            /* Styles for the Search and Filter Bar */
            .filter-bar {
                display: flex; gap: 15px; margin: 0 50px 20px;
                ...
                <table id="eventsTable">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <% if (isPastEvent) { %>
                                <span style="display:inline-block; margin-left:5px; color:#6c757d; font-weight:bold; background: #eee; padding: 5px 10px; border-radius: 4px;">Finished</span>
                                <a href="feedbackForm.jsp?eventID=<%= e.getEventID() %>" 
                                   style="display:inline-block; margin-left:5px; background:#0d47a1; color:white; padding:5px 12px; border-radius:4px; text-decoration:none; font-weight:bold; font-size:13px;">
                                    &#128221; Give Feedback
                                </a>
                            <% } else { %>
                                <form action="EventServlet" method="POST" style="display:inline; margin-left: 5px;">
                                    ...
                                    <button type="submit" class="btn-reject" onclick="return confirm('Are you sure you want to cancel your seat? This will give your spot to someone else.');">Cancel RSVP</button>
                                </form>
                            <% } %>
                        </td>
                    </tr>
