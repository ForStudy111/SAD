    ...
    <div class="container">
        <div class="main-content">
            ...
            <div class="alert-info">
                ℹ️ You can only submit feedback for events that have already ended.
            </div>
            ...
            <form action="ReportFeedbackServlet" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select id="eventID" name="eventID" required>
                        ...
                        <%
                            // Fetch events that have ALREADY ENDED (eventDate < CURDATE())
                            try {
                                Class.forName("com.mysql.cj.jdbc.Driver");
                                Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/comtech_db", "root", "");
                                // TAMBAH SYARAT: eventDate < CURDATE() - HANYA EVENT YANG SUDAH LEPAS
                                String sql = "SELECT eventID, eventName FROM club_event WHERE status = 'Approved' AND eventDate < CURDATE() ORDER BY eventDate DESC";
                        ...
                        <%
                                ...
                                if (!hasEvents) {
                        %>
                                    <option value="" disabled>No completed events available for feedback</option>
                        <%
                                }
